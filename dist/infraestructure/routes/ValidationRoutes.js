...
router.post('/', authenticateToken, requireExpertRole, validationController.validateQuestion.bind(validationController));
// GET /validations/question/:questionId - Historial de validaciones de pregunta (JWT)
router.get('/question/:questionId', authenticateToken, validationController.getValidationsByQuestion.bind(validationController));
// GET /validations/my-validations - Mis validaciones (JWT + DocenteExperto)
router.get('/my-validations', authenticateToken, requireExpertRole, validationController.getMyValidations.bind(validationController));
